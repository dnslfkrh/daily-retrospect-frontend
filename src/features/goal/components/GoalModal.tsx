...
const GoalModal = ({ goal, onClose, onSave }: { goal: Goal | null; onClose: () => void; onSave: (data: Goal) => void }) => {
  ...
  const handleSave = () => {
    onSave({ ...goal, title, description, start_date: startDate, end_date: endDate } as Goal);
    onClose();
  };
