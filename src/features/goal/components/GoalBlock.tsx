...
const GoalBlock = ({ goal }: GoalProps) => {
  return (
    <div className="relative bg-white px-6 py-4 rounded-lg shadow-md border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      {/* 수정 & 삭제 아이콘 우측 상단 배치 */}
      ...
      {/* 설명 공간을 항상 일정하게 유지 */}
      <p className="text-sm text-gray-600 min-h-[15px] dark:text-gray-300">
